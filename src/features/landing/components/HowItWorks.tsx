    ...
    <section className="py-24 bg-surface-container-lowest">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {steps.map((step) => (
            <Card key={step.id} className="group bg-surface-container-low rounded-[2.5rem] p-4 h-full shadow-low hover:shadow-high transition-all duration-500 hover:-translate-y-2 border-none">
              <CardHeader className="p-6">
                <div className="w-16 h-16 rounded-2xl bg-primary-container text-on-primary flex items-center justify-center mb-8 text-2xl font-black shadow-lg shadow-primary-container/20">
                  {step.id}
                </div>
              ...
              <CardContent className="p-6 pt-0">
                <p className="text-on-surface-variant leading-relaxed font-medium mb-10">
                  {step.description}
                </p>
                <div className="bg-surface-container-lowest rounded-3xl p-4 shadow-low overflow-hidden group-hover:shadow-md transition-shadow">
