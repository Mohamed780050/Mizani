  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 mt-8">
        {error && (
          <div className="text-rose-500 text-sm font-bold bg-rose-500/10 p-3 rounded-lg">
            {error}
          </div>
        )}
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className="bg-card border-none py-6 rounded-xl font-bold shadow-sm"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            placeholder="0.00"
            className="bg-card border-none py-6 rounded-xl font-mono font-black text-emerald-600 text-lg shadow-sm"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="bg-card border-none py-6 pl-9 rounded-xl font-bold shadow-sm"
            />
          </div>
        </div>
        ...
        <Button
          disabled={isPending}
          type="submit"
          className="w-full py-6 font-bold rounded-xl mt-4 bg-emerald-600 hover:bg-emerald-700"
        >
          {isPending ? (
  ...
  return (
    <div className="bg-card rounded-[32px] border border-border/50 p-6 flex flex-col justify-between shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
      ...
      <div>
        ...
        <h3 className="font-extrabold tracking-tight text-xl mb-1">
          {goal.title}
        </h3>
